./test_trans /home/jamiez/Desktop/StarStuff/starfitter/Mirror_Survey_Photos/TAX4/ 1>process.log 2>process.log
...
find /home/jamiez/Desktop/StarStuff/starfitter/Mirror_Survey_Photos/TAX4/ -type f -name "img_????.???.csv*" -exec wc '{}' \; | awk '{print $NF" "$1}' | awk -F / '{print $NF}' | sort | uniq > results/csvfile_status.results
