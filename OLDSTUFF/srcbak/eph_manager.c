...
short int
ephem_open (char *ephem_name,
	    double *jd_begin, double *jd_end, short int *de_number)
/*
------------------------------------------------------------------------
...
short int
planet_ephemeris (double tjd[2], short int target,
		  short int center, double *position, double *velocity)
/*
------------------------------------------------------------------------
...
*/
{
  ...
  double jed[2];
  double pos_moon[3] = { 0.0, 0.0, 0.0 }, vel_moon[3] =
  {
  0.0, 0.0, 0.0}, pos_earth[3] =
  {
  0.0, 0.0, 0.0}, vel_earth[3] =
  {
  0.0, 0.0, 0.0};
  double target_pos[3] = { 0.0, 0.0, 0.0 }, target_vel[3] =
  {
  0.0, 0.0, 0.0}, center_pos[3] =
  {
  0.0, 0.0, 0.0}, center_vel[3] =
  {
  0.0, 0.0, 0.0};
...
short int
state (double *jed, short int target, double *target_pos, double *target_vel)
/*
------------------------------------------------------------------------
...
void
interpolate (double *buf, double *t, long int ncf, long int na,
